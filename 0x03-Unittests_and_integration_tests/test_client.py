...
class TestGithubOrgClient(unittest.TestCase):
    """
    to test GithubOrgClient class methods
    """
    ...
    def test_org(self, org, mock_org):
        """
        test's TestGithubOrgClient's org method
        Args:
    ...
    def test_public_repos_url(self):
        """
        to test TestGithubOrgClient's _public_repos_url method works
        as expected.
        """
    ...
    def test_public_repos(self, mock_repo):
        """
        to test GithubOrgClient's public_repos method
        """
        with patch.object(GithubOrgClient,
                          '_public_repos_url',
    ...
    def test_has_license(self, repo, license_key, expected):
        """
        to test GithubOrgClient's has_license method
        Args:
...
class TestIntegrationGithubOrgClient(unittest.TestCase):
    ...
    def test_public_repos_with_license(self):
        """
        to test public_repos method with license
        """
        self.assertEqual(
